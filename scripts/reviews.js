const reviews = [
    { title: 'Stalaggh - Projekt Misanthropia', description: 'A truly disturbing horror experience...', genre: 'Horror', releaseDate: '2023-12-01', score: '2/10', image: 'images/86179-projekt-misanthropia.jpg' },
    { title: 'Wolf Eyes - Burned Mind', description: 'Wolf eyes are quite a famous band in the realm of noise and this is one of their most famous projects, often times quoted as a gateway album in the musical genre known as noise. Each song is a compendium of noises (static screeches, buzzes, feedback and so on) and screams with the clear intention of creating an atmosphere as dark and abrasive as possible. Most of the songs on here work perfectly and coherently to this theme of oppression and violence, though in the second half the musical ideas become less powerful like on "Urine Burn" or "Ancient Delay". All considered a solid release and a good starting point to venture in the dark underground of noise music.', genre: 'Noise', releaseDate: '2011-11-20', score: '7/10', image: 'images/your-image.jpg' },
...
const updatePaginationButtons = () => {
    ...
    document.getElementById('next-btn').disabled = currentPage * reviewsPerPage >= reviews.length;
};
...
const searchReviews = () => {
    ...
    const filteredReviews = reviews.filter(review => 
        review.title.toLowerCase().includes(query) || review.description.toLowerCase().includes(query)
    );
    const container = document.getElementById('reviews-container');
